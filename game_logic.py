...
def get_ai_suggestion(board):
    """
    Main AI suggestion function - uses fast AI by default for quick responses.
    For maximum performance, use get_ai_suggestion_expert() instead.
    """
    return get_ai_suggestion_fast(board)
